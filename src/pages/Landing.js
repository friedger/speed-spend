          ...
          <div className="panel-landing text-center mt-3">
            ...
            <div className="card mt-4 border-info">
              <div className="card-header">
                <h5 className="card-title">About Stacks Testnet (Krypton)</h5>
              </div>
              <div className="row">
                <div className="col col-md-12 p-4">
                  ...
                  <i>Krypton</i> all nodes validate the network, they can mine new blocks, and they
                  connect to the same bitcoin regtest node.
                </div>
              </div>
            </div>
